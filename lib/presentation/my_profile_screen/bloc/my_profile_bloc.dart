...
import 'package:renta_buddy/presentation/my_profile_screen/models/my_profile_model.dart';
...
class MyProfileBloc extends Bloc<MyProfileEvent, MyProfileState> {
  ...
  _onInitialize(
    ...
    emit(state.copyWith(
      advertisementsController: TextEditingController(),
      youSayWhatYouController: TextEditingController(),
